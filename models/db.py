...
if __name__ == "__main__":
    session = create_db()
    # u1 = Users(LoginId="alice", email="alice@example.com", password_hash="hash1")
    # u2 = Users(LoginId="bob", email="bob@example.com", password_hash="hash2")
    # u3 = Users(LoginId="charlie", email="charlie@example.com", password_hash="hash3")
    # users = [u1, u2, u3]
    #
